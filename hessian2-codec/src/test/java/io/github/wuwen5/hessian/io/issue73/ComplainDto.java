 ...
 */
package io.github.wuwen5.hessian.io.issue73;
...
public class ComplainDto implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        return Objects.equals(complainOrderId, that.complainOrderId)
                && Objects.equals(complainDate, that.complainDate)
                && Objects.equals(complainStatus, that.complainStatus)
                && Objects.equals(complainStatusName, that.complainStatusName)
                && Objects.equals(customerName, that.customerName)
                && Objects.equals(class1Name, that.class1Name)
                && Objects.equals(class2Name, that.class2Name)
                && Objects.equals(class3Name, that.class3Name)
                && Objects.equals(remark, that.remark)
                && Objects.equals(appealReason, that.appealReason)
                && Objects.equals(userAccessory, that.userAccessory)
                && Objects.equals(complainOi, that.complainOi)
                && Objects.equals(surplusDate, that.surplusDate)
                && Objects.equals(complainResult, that.complainResult)
                ...
                && Objects.equals(showType, that.showType);
    }
