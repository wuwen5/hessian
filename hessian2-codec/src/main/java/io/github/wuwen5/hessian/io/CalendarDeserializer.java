 ...
 * @author wuwen
 */
public class CalendarDeserializer extends AbstractDeserializer {
    ...
    CalendarDeserializer(Class<?> cls) {
        this.cls = cls;
    }
    ...
    public Object readObject(AbstractHessianDecoder in, Object[] fields) throws IOException {
        Object obj = new CalendarHandle(cls, in.readUTCDate()).readResolve();
        in.addRef(obj);
        return obj;
    }
}
