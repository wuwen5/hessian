...
public class TestHessian2Servlet extends HessianServlet implements TestHessian2 {
    ...
    private byte[] toBinary(String s) {
        ...
        for (int i = 0; i < s.length(); i++) buffer[i] = (byte) s.charAt(i);
    ...
    public Object argInt_0x7fffffff(Object v) {
        if (v instanceof Integer) {
            ...
            if (value == 0x7fffffff) return true;
        }
    ...
    public Object argLong_0(Object v) {
        if (v.equals(replyLong_0())) return true;

        return getInputDebug();
    }

    public Object argLong_1(Object v) {
        if (v.equals(replyLong_1())) return true;

        return getInputDebug();
    }

    public Object argLong_15(Object v) {
        if (v.equals(replyLong_15())) return true;

        return getInputDebug();
    }

    public Object argLong_m8(Object v) {
        if (v.equals(replyLong_m8())) return true;
    ...
    public Object argLong_0x10(Object v) {
        if (v.equals(replyLong_0x10())) return true;

        return getInputDebug();
    }

    public Object argLong_0x7ff(Object v) {
        if (v.equals(replyLong_0x7ff())) return true;

        return getInputDebug();
    }

    public Object argLong_m9(Object v) {
        if (v.equals(replyLong_m9())) return true;

        return getInputDebug();
    }

    public Object argLong_m0x800(Object v) {
        if (v.equals(replyLong_m0x800())) return true;

        return getInputDebug();
    }

    public Object argLong_0x800(Object v) {
        if (v.equals(replyLong_0x800())) return true;

        return getInputDebug();
    }

    public Object argLong_0x3ffff(Object v) {
        if (v.equals(replyLong_0x3ffff())) return true;

        return getInputDebug();
    }

    public Object argLong_m0x801(Object v) {
        if (v.equals(replyLong_m0x801())) return true;

        return getInputDebug();
    }

    public Object argLong_m0x40000(Object v) {
        if (v.equals(replyLong_m0x40000())) return true;
    ...
    public Object argLong_0x40000(Object v) {
        if (v.equals(replyLong_0x40000())) return true;

        return getInputDebug();
    }

    public Object argLong_0x7fffffff(Object v) {
        if (v.equals(replyLong_0x7fffffff())) return true;

        return getInputDebug();
    }

    public Object argLong_m0x40001(Object v) {
        if (v.equals(replyLong_m0x40001())) return true;

        return getInputDebug();
    }

    public Object argLong_m0x80000000(Object v) {
        if (v.equals(replyLong_m0x80000000())) return true;

        return getInputDebug();
    }

    public Object argLong_0x80000000(Object v) {
        if (v.equals(replyLong_0x80000000())) return true;

        return getInputDebug();
    }

    public Object argLong_m0x80000001(Object v) {
        if (v.equals(replyLong_m0x80000001())) return true;
    ...
    public Object argDate_0(Object v) {
        if (v.equals(replyDate_0())) return true;

        return getInputDebug();
    }

    public Object argDate_1(Object v) {
        if (v.equals(replyDate_1())) return true;

        return getInputDebug();
    }

    public Object argDate_2(Object v) {
        if (v.equals(replyDate_2())) return true;
    ...
    public Object argBinary_0(Object v) {
        ...
        if (equals(expect, v)) return true;
